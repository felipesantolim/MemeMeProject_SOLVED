...
class MemeMeViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    private func generateMemedImage () -> UIImage {
        ...
        navigationAndToolbarAvailable(true)
        ...
        navigationAndToolbarAvailable(false)
        
        return memedImage
    }
    
    private func navigationAndToolbarAvailable (_ isAvailable: Bool) {
        mainView.memeTolbarControl.isHidden = isAvailable
        self.navigationController?.setNavigationBarHidden(isAvailable, animated: false)
    }
}
